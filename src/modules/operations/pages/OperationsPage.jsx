...
export default function Operations() {
  ...
  return (
    <div className="animate-fade-in" style={{background: '#f7fbfc', minHeight: '100vh'}}>
      {/* Header con branding dorado */}
      <div className="mb-8">
        <div className="flex items-center justify-between mb-2">
          <div>
            <h1 className="text-3xl font-display font-bold" style={{
              background: 'linear-gradient(135deg, #b4860b 0%, #087f8c 50%, #e8c97a 100%)',
              WebkitBackgroundClip: 'text',
              WebkitTextFillColor: 'transparent',
              backgroundClip: 'text'
            }}>Estrategia y Operaciones</h1>
            <p className="text-sm mt-1" style={{color: activeCompany ? 'rgba(8,145,160,0.6)' : 'rgba(8,145,160,0.4)'}}>
              {activeCompany ? activeCompany.name : 'Selecciona una empresa para comenzar'}
            </p>
          </div>
        </div>
        <div className="h-px w-full" style={{
          background: 'linear-gradient(90deg, transparent, rgba(8,145,160,0.3), rgba(8,145,160,0.5), rgba(8,145,160,0.3), transparent)'
        }} />
      </div>
          ...
          {[
            ...
            <button
              ...
              style={activeTab === tab.id ? {
                ...
                color: '#087f8c',
                border: '1px solid rgba(8,145,160,0.3)',
                boxShadow: '0 2px 8px rgba(8,145,160,0.1)'
              } : {
                background: 'rgba(8,145,160,0.05)',
                color: 'rgba(51,65,85,0.6)',
                border: '1px solid rgba(8,145,160,0.1)'
              }}
            >
